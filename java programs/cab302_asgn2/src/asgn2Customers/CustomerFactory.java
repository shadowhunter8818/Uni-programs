...
public class CustomerFactory {
	...
	public static Customer getCustomer(String customerCode, String name, String mobileNumber, int locationX,  int locationY) throws CustomerException{
		...
		if (customerCode != null){
			if (!(customerCode.equals("DVC") || customerCode.equals("DNC") || customerCode.equals("PUC"))){
				throw new CustomerException("Contains an invalid customer code");
			}
			else{
				if (name != null && mobileNumber != null) {

					if (customerCode.equals("DVC")) {
						C = new DriverDeliveryCustomer(name,mobileNumber, locationX, locationY);
					}
					else if (customerCode.equals("DNC")) {
						C = new DroneDeliveryCustomer(name,mobileNumber, locationX, locationY);
					}
					else {
						C = new PickUpCustomer(name,mobileNumber, locationX, locationY);
					}
				}
				else {
					throw new CustomerException("The customer name and/or mobile number strings are null");
				}
			}
		}
		else {
			throw new CustomerException("The customer code is null");
		}
